...
# raise if length of sde_tags and/or sde_flags is not 1
if [ ${#sde_tags[@]} -ne 1 ] || [ ${#sde_flags[@]} -ne 1 ]; then
  echo "Error: sde_tags and sde_flags must have length 1"
  exit 1
fi
...
# Original sweep:
dir_tags=(fwd rev_repa fwdnoise revnoise_repa)
dir_flags=(
  "--no-reverse"
  "--no-forward"
...
model_ckpts=(
    "hf://therealgabeguo/BiB_generative/ablations/07_06_26/data_to_data/fwd/step_0200000.pt"
    # "hf://therealgabeguo/BiB_generative/ablations/07_06_26/data_to_data/rev/step_0200000.pt"
    "hf://therealgabeguo/BiB_generative/ablations/07_16_26/data_to_data/rev_repa/step_0200000.pt"
    "hf://therealgabeguo/BiB_generative/ablations/07_06_26/noise_to_data/fwd/step_0200000.pt"
    # "hf://therealgabeguo/BiB_generative/ablations/07_06_26/noise_to_data/rev/step_0200000.pt"
    "hf://therealgabeguo/BiB_generative/ablations/07_16_26/noise_to_data/rev_repa/step_0200000.pt"
)
...
for si in "${!sde_tags[@]}"; do
    for di in "${!dir_tags[@]}"; do
      ...
      curr_model_ckpt="${model_ckpts[$di]}"
